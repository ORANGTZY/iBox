...
<header id="header" class="header-scroll top-header headrom">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-toggleable-md float-lg-right" id="mainNavbarCollapse">
                <ul class="nav navbar-nav">
                    ...
                    <!-- PHP untuk menampilkan menu login / registrasi atau logout / my orderstergantung status login -->
                     <?php
    ...
    <div style="background-image: url('images/store-iBox.jpg');">
